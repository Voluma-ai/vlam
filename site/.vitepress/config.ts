    ...
    sidebar: {
      '/examples/': [
        ...
        },
        {
          text: 'Going further',
          items: [
            { text: '7. Frame the capture', link: '/examples/frame-the-camera' },
            { text: '8. Surface queries', link: '/examples/surface-queries' },
            { text: '9. Shader effects', link: '/examples/shader-effects' },
            { text: '10. Select and cut', link: '/examples/select-and-cut' },
            { text: '11. Depth of field', link: '/examples/depth-of-field' },
            { text: '12. Relight', link: '/examples/relight' },
            { text: '13. Tiny planet', link: '/examples/tiny-planet' },
            { text: '14. Write your own effect', link: '/examples/custom-effect' },
          ],
        },
        {
          text: 'Shipping it',
          items: [
            { text: '15. Use it from React', link: '/examples/react-viewer' },
            { text: '16. Annotations', link: '/examples/annotations' },
            { text: '17. Fast on a phone', link: '/examples/fast-on-phones' },
            { text: '18. The WebGL2 fallback', link: '/examples/webgl-fallback' },
            { text: '19. View it in VR', link: '/examples/in-vr' },
            { text: '20. Share a viewpoint', link: '/examples/share-a-viewpoint' },
          ],
        },
        {
          text: 'Reference',
