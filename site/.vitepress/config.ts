      ...
      '/examples/': [
        {
          ...
          items: [
            ...
            { text: '3. Huge scenes', link: '/examples/big-scenes' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: '12. Write your own effect', link: '/examples/custom-effect' },
          ],
        },
        {
          text: 'Shipping it',
          items: [
            { text: '13. Use it from React', link: '/examples/react-viewer' },
            { text: '14. Annotations', link: '/examples/annotations' },
            { text: '15. Fast on a phone', link: '/examples/fast-on-phones' },
            { text: '16. The WebGL2 fallback', link: '/examples/webgl-fallback' },
            { text: '17. View it in VR', link: '/examples/in-vr' },
            { text: '18. Share a viewpoint', link: '/examples/share-a-viewpoint' },
          ],
        },
        {
          text: 'Reference',
