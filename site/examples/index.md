...
7. **[Frame the capture](/examples/frame-the-camera)**: measure bounds and fit the camera.
8. **[Surface queries](/examples/surface-queries)**: use CPU queries for floor probes and measurements.
